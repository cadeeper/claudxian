...
export type TranslationKey =
  ...
  | 'settings.codex.cliDetection.name'
  | 'settings.codex.cliDetection.resolved'
  | 'settings.codex.cliDetection.missing'
  | 'settings.codex.cliPath.name'
  | 'settings.codex.cliPath.desc'
  | 'settings.codex.model.name'
  | 'settings.codex.model.desc'
  | 'settings.codex.quickModels.name'
  | 'settings.codex.quickModels.desc'
  | 'settings.codex.reasoning.name'
  | 'settings.codex.reasoning.desc'
  | 'settings.codex.planReasoning.name'
  | 'settings.codex.planReasoning.desc'
  | 'settings.customization'
